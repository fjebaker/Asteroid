...
def test_invalid_url_raises_missing_schema():
    """Test a requests.exceptions.MissingSchema is raised when an invalid url
    is passed."""
...
def test_valid_not_song_url_raises_type_error():
    """Test a TypeError is raised when a valid url is passed, but the content is not an audio file."""
