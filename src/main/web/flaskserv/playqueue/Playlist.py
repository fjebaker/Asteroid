...
class Playlist(metaclass=DBAccessory):
    ...
    def create_table(self):
        ...
        TODO
        """
        self.db_inst.create_table(
            "playlist", self.k_type, additional=", CONSTRAINT s_id_unique UNIQUE (s_id)")
    ...
    def update_vote(self, s_id, vote):
        ...
        c_vote = self.db_inst.select_rows(
            "playlist", ("vote",), {1: s_id})[0]["vote"]
    ...
    def get_most_voted(self):
        ...
        TODO
        """
        most_voted_song = self.db_inst.select_rows(
            "playlist", ("*",), {0: ""}, like=True, orderlimit="ORDER BY vote DESC LIMIT 1")
